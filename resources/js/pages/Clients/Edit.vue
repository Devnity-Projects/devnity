...
import { ArrowLeft, Save, Edit, User, Mail, MapPin, FileText } from 'lucide-vue-next'
        ...
        <div class="devnity-card">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              <div v-if="form.errors.document" class="mt-2 text-sm text-red-600 dark:text-red-400">
