    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Atualize as informações do projeto "{{ props.project.name }}"
        </p>
      </div>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                :class="[
                  'devnity-input',
                  errors.hours_worked ? 'border-red-300 dark:border-red-600' : ''
                ]"
                placeholder="0"
              />
              <p v-if="errors.hours_worked" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ errors.hours_worked }}
              </p>
            </div>
          </div>
